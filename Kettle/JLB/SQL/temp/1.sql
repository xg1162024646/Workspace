...
TRUNCATE TABLE F_KMS_ORDER_FORM_DETAIL_STG;
TRUNCATE TABLE F_KMS_ORDER_FORM_DETAIL;
TRUNCATE TABLE F_KMS_ORDER_GOODS_DETAIL_STG;
TRUNCATE TABLE F_KMS_ORDER_GOODS_DETAIL;
